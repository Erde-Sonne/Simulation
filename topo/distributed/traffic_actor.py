		...
		if self.prev_mode == "small":
			if mode == "large":
				...
				if self.cnt % 6 == 0:
					for hid in [7, 8, 9]:
						if hid in self.hostids:
							self._start_traffic_to_target_list(hid, [19, 20, 21, 31, 32, 33], "video",
							                                   True)
				if self.cnt % 6 == 1:
					for hid in [7, 8, 9]:
						if hid in self.hostids:
							self._start_traffic_to_target_list(hid, [19, 20, 21, 31, 32, 33],
							                                   "video", True)
				if self.cnt % 6 == 2:
					for hid in [7, 8, 9]:
						if hid in self.hostids:
				...
				if self.cnt % 6 == 4:
					for hid in [0, 1, 2]:
						if hid in self.hostids:
							self._start_traffic_to_target_list(hid, [12, 13, 14, 24, 25, 26],
							                                   "video", True)
				if self.cnt % 6 == 5:
					for hid in [0, 1, 2]:
						if hid in self.hostids:
